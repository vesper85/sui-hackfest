            ...
            <Tabs defaultValue="invest">
                ...
                <CardContent className="space-y-4">
                    <TabsContent value="invest" className="mt-0 space-y-4">
                        ...
                        <Button className="w-full" size="lg" disabled={!investAmount || Number(investAmount) < pool.minInvestment}>
                            Invest Now
                        </Button>
                    </TabsContent>
                    ...
                    <TabsContent value="redeem" className="mt-0 space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{(pool.redeemRate * 100).toFixed(0)}%</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-muted-foreground flex items-center gap-1">
                                    Performance Fee
                                ...
                                <>
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-red-500">
                                            -${((Number(redeemAmount) * pool.performanceFee) / 100).toFixed(2)}
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-sm pt-2 border-t">
                        ...
                        <Button className="w-full" size="lg" variant="outline" disabled={!redeemAmount}>
                            Redeem
                        </Button>
                    </TabsContent>
                </CardContent>
