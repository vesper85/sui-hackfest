...
export const userTypeEnum = pgEnum("user_type", ["borrower", "lender", "both"]);
export const kycStatusEnum = pgEnum("kyc_status", ["pending", "approved", "rejected"]);
export const borrowerTypeEnum = pgEnum("borrower_type", ["individual", "business"]);
...
export const borrowerProfiles = pgTable("borrower_profiles", {
    ...
    totalLiabilitiesUsd: decimal("total_liabilities_usd", { precision: 20, scale: 2 }),
...
export const documentSubmissions = pgTable("document_submissions", {
    id: uuid("id").primaryKey().defaultRandom(),
    borrowerId: uuid("borrower_id").references(() => borrowerProfiles.id).notNull(),
    submissionReference: varchar("submission_reference", { length: 100 }).unique().notNull(),
...
export const documents = pgTable("documents", {
    id: uuid("id").primaryKey().defaultRandom(),
    submissionId: uuid("submission_id").references(() => documentSubmissions.id).notNull(),
...
export const documentExtractions = pgTable("document_extractions", {
    ...
    extractionCostUsd: decimal("extraction_cost_usd", { precision: 10, scale: 4 }),
});
...
export const underwritingReports = pgTable("underwriting_reports", {
    ...
    monthlyIncomeUsd: decimal("monthly_income_usd", { precision: 20, scale: 2 }),
    monthlyExpensesUsd: decimal("monthly_expenses_usd", { precision: 20, scale: 2 }),
    ...
    recommendedLtvRatio: decimal("recommended_ltv_ratio", { precision: 5, scale: 2 }),
    ...
    requiredCollateralUsd: decimal("required_collateral_usd", { precision: 20, scale: 2 }),
...
export const collateralAssets = pgTable("collateral_assets", {
    ...
    estimatedValueUsd: decimal("estimated_value_usd", { precision: 20, scale: 2 }).notNull(),
    verificationStatus: verificationStatusEnum("verification_status").notNull().default("pending"),
    verificationSource: varchar("verification_source", { length: 255 }),
    liquidationValueUsd: decimal("liquidation_value_usd", { precision: 20, scale: 2 }),
    metadata: jsonb("metadata"),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
export const lendingPools = pgTable("lending_pools", {
    ...
    // Pool Metrics
    totalValueLockedUsd: decimal("total_value_locked_usd", { precision: 20, scale: 2 }).default("0").notNull(),
    availableLiquidityUsd: decimal("available_liquidity_usd", { precision: 20, scale: 2 }).default("0").notNull(),
    totalLoansActive: integer("total_loans_active").default(0).notNull(),
    totalLoansValueUsd: decimal("total_loans_value_usd", { precision: 20, scale: 2 }).default("0").notNull(),
    totalDefaultsCount: integer("total_defaults_count").default(0).notNull(),
    totalDefaultsValueUsd: decimal("total_defaults_value_usd", { precision: 20, scale: 2 }).default("0").notNull(),
    ...
    protocolFeePercentage: decimal("protocol_fee_percentage", { precision: 5, scale: 2 }).default("2.0").notNull(),
    ...
    targetUtilizationRate: decimal("target_utilization_rate", { precision: 5, scale: 2 }).default("0.8"),
    maxUtilizationRate: decimal("max_utilization_rate", { precision: 5, scale: 2 }).default("0.95"),
...
export const loans = pgTable("loans", {
    id: uuid("id").primaryKey().defaultRandom(),
    poolId: uuid("pool_id").references(() => lendingPools.id).notNull(),
    borrowerId: uuid("borrower_id").references(() => borrowerProfiles.id).notNull(),
    underwritingReportId: uuid("underwriting_report_id").references(() => underwritingReports.id).notNull(),
    ...
    originationFeeUsd: decimal("origination_fee_usd", { precision: 20, scale: 2 }),

    // Amounts
    totalRepaymentAmountUsd: decimal("total_repayment_amount_usd", { precision: 20, scale: 2 }).notNull(),
    outstandingBalanceUsd: decimal("outstanding_balance_usd", { precision: 20, scale: 2 }).notNull(),
    accruedInterestUsd: decimal("accrued_interest_usd", { precision: 20, scale: 2 }).default("0").notNull(),
    totalPaidUsd: decimal("total_paid_usd", { precision: 20, scale: 2 }).default("0").notNull(),

    // On-chain
    loanContractAddress: varchar("loan_contract_address", { length: 255 }),
    fundingTxHash: varchar("funding_tx_hash", { length: 255 }),
    borrowerWalletAddress: varchar("borrower_wallet_address", { length: 255 }).notNull(),
...
export const loanRepayments = pgTable("loan_repayments", {
    ...
    paymentAmountUsd: decimal("payment_amount_usd", { precision: 20, scale: 2 }).notNull(),
    principalAmountUsd: decimal("principal_amount_usd", { precision: 20, scale: 2 }).notNull(),
    interestAmountUsd: decimal("interest_amount_usd", { precision: 20, scale: 2 }).notNull(),
    lateFeeUsd: decimal("late_fee_usd", { precision: 20, scale: 2 }).default("0").notNull(),
...
export const poolDeposits = pgTable("pool_deposits", {
    id: uuid("id").primaryKey().defaultRandom(),
    poolId: uuid("pool_id").references(() => lendingPools.id).notNull(),
    lenderUserId: uuid("lender_user_id").references(() => users.id).notNull(),
    depositAmountUsd: decimal("deposit_amount_usd", { precision: 20, scale: 2 }).notNull(),
    lpTokensMinted: decimal("lp_tokens_minted", { precision: 20, scale: 8 }).notNull(),
    txHash: varchar("tx_hash", { length: 255 }).notNull(),
...
export const poolWithdrawals = pgTable("pool_withdrawals", {
    ...
    poolId: uuid("pool_id").references(() => lendingPools.id).notNull(),
    lenderUserId: uuid("lender_user_id").references(() => users.id).notNull(),
    withdrawalAmountUsd: decimal("withdrawal_amount_usd", { precision: 20, scale: 2 }).notNull(),
    lpTokensBurned: decimal("lp_tokens_burned", { precision: 20, scale: 8 }).notNull(),
    txHash: varchar("tx_hash", { length: 255 }).notNull(),
...
export const borrowerProfilesRelations = relations(borrowerProfiles, ({ one, many }) => ({
    user: one(users, {
...
export const documentSubmissionsRelations = relations(documentSubmissions, ({ one, many }) => ({
...
export const underwritingReportsRelations = relations(underwritingReports, ({ one, many }) => ({
    submission: one(documentSubmissions, {
